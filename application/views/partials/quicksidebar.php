    ...
    <div class="page-quick-sidebar">
        ...
        <div class="tab-content">
            <div class="tab-pane active page-quick-sidebar-chat" id="quick_sidebar_tab_1">
                <div class="page-quick-sidebar-list" style="position: relative; overflow: hidden; width: auto; height: 603px;"><div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list" data-height="603" style="overflow: hidden; width: auto; height: 603px;" data-initialized="1">
                    ...
                    <ul class="media-list list-items">
                        <li class="media">
                            ...
                            <img class="media-object" src="/img/avatar3(2).jpg" alt="...">
                        ...
                        <li class="media">
                            <img class="media-object" src="/img/avatar1(2).jpg" alt="...">
                            <div class="media-body">
                        ...
                        <li class="media">
                            ...
                            <img class="media-object" src="/img/avatar4(1).jpg" alt="...">
                            <div class="media-body">
                        ...
                        <li class="media">
                            <img class="media-object" src="/img/avatar2(2).jpg" alt="...">
                            <div class="media-body">
                    ...
                    <ul class="media-list list-items">
                        <li class="media">
                            ...
                            <img class="media-object" src="/img/avatar6(1).jpg" alt="...">
                            <div class="media-body">
                        ...
                        <li class="media">
                            ...
                            <img class="media-object" src="/img/avatar7(1).jpg" alt="...">
                            <div class="media-body">
                        ...
                        <li class="media">
                            <img class="media-object" src="/img/avatar8(1).jpg" alt="...">
                            <div class="media-body">
                        ...
                        <li class="media">
                            ...
                            <img class="media-object" src="/img/avatar9(1).jpg" alt="...">
                            <div class="media-body">
                        ...
                        <li class="media">
                            <img class="media-object" src="/img/avatar10(1).jpg" alt="...">
                            <div class="media-body">
                ...
                </div><div class="slimScrollBar" style="background: rgb(187, 187, 187); width: 7px; position: absolute; top: 0px; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 1px; height: 416.505px;"></div><div class="slimScrollRail" style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(221, 221, 221); opacity: 0.2; z-index: 90; right: 1px;"></div></div>
                <div class="page-quick-sidebar-item">
                    <div class="page-quick-sidebar-chat-user">
                        ...
                        <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 498px;"><div class="page-quick-sidebar-chat-user-messages" data-height="498" style="overflow: hidden; width: auto; height: 498px;" data-initialized="1">
                            <div class="post out">
                                <img class="avatar" alt="" src="/img/avatar3(2).jpg">
                                <div class="message">
                            ...
                            <div class="post in">
                                <img class="avatar" alt="" src="/img/avatar2(2).jpg">
                                <div class="message">
                                    <span class="arrow"></span>
                        ...
                        </div><div class="slimScrollBar" style="background: rgb(187, 187, 187); width: 7px; position: absolute; top: 0px; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 1px; height: 366.87px;"></div><div class="slimScrollRail" style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(234, 234, 234); opacity: 0.2; z-index: 90; right: 1px;"></div></div>
            ...
            <div class="tab-pane page-quick-sidebar-alerts" id="quick_sidebar_tab_2">
                <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 598px;"><div class="page-quick-sidebar-alerts-list" data-height="598" style="overflow: hidden; width: auto; height: 598px;" data-initialized="1">
            ...
            <div class="tab-pane page-quick-sidebar-settings" id="quick_sidebar_tab_3">
                <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 598px;"><div class="page-quick-sidebar-settings-list" data-height="598" style="overflow: hidden; width: auto; height: 598px;" data-initialized="1">
