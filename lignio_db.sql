...
INSERT INTO `master_diagnostic_tests` VALUES (1,1,'Sugar Fasting','3 mL Blood','A blood glucose test measures the amount of glucose in your blood. Glucose, a type of simple sugar, is your body’s main source of energy. Your body converts the carbohydrates you eat into glucose.','1512809012568','1512809012568',1);
...
INSERT INTO `menus` VALUES (1,'Bookings','#','0',1,NULL,NULL,1),(2,'View Bookings','/Booking','1',1,NULL,NULL,1),(3,'New Booking','/Booking/create','1',2,NULL,NULL,1),(4,'Profile','/Profile','0',3,NULL,NULL,1),(5,'Diagnostic Tests','/DiagnosticTest','0',2,NULL,NULL,1),(6,'View Diagnostic Tests','/DiagnosticTest','5',1,NULL,NULL,1),(7,'Add New','/DiagnosticTest/create','5',2,NULL,NULL,1),(8,'Master Diagnostic Tests','/MasterDiagnosticTests','0',0,NULL,NULL,1),(9,'Master Data','/MasterData','0',1,NULL,NULL,1);
...
INSERT INTO `role_permissions` VALUES (1,1,2),(2,1,4),(3,1,8),(4,1,11),(5,1,12),(6,2,9),(7,2,10),(8,2,2),(9,4,14),(10,4,13),(11,1,16),(12,5,17),(13,5,18),(14,5,19),(15,5,20),(16,5,21),(17,5,22),(18,5,23),(19,5,24);
...
INSERT INTO `status` VALUES (1,'Pending'),(2,'Sample Collection Pending'),(3,'Sample Collection Completed'),(4,'Lab Analysis In Progress'),(5,'Lab Analysis Completed'),(6,'Approval Pending'),(7,'Approved'),(8,'Rejected'),(9,'Payment Pending'),(10,'Completed');
...
-- Dump completed on 2017-12-23 22:35:37
